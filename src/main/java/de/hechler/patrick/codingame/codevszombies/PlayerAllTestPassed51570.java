...
/**
 * passes all tests and gets 51570 points
 **/
class PlayerAllTestPassed51570 {
	...
	static class Entities<E extends Entity> implements Iterable<E> {
	...
	static class Ash extends Entity {
	...
	static class Zombie extends Entity {
